...
const BUTTON_TYPE_CLASSES = {
  ...
  warning:
    'bg-red-400 text-neutral-800 hover:bg-neutral-800 hover:text-red-400 mt-52 active:bg-red-300 active:text-neutral-800 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-50',
  green:
